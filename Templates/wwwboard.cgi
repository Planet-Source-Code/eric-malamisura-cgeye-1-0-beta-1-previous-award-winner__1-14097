#!/usr/local/bin/perl
##############################################################################
# WWWBoard   test                   Version 2.0 ALPHA 2.1                        #
...
$basedir = "/data1/hypermart.net/elucidsoftware/cgi";
$baseurl = "http://elucidsoftware.hypermart.net/cgi";
$cgi_url = "http://elucidsoftware.hypermart.net/cgi/wwwboard.cgi";
...
sub new_file {
   ...
   print NEWFILE "  </head>\n";
   print NEWFILE "  <body link=\"#3366CC\" vlink=\"#3366CC\" alink=\"#0033CC\">\n";
   print NEWFILE "    <center>\n";
   print NEWFILE "      <h1>$subject</h1>\n";
   print NEWFILE "    </center>\n";
   print NEWFILE "<hr size=1 color=\"#0099FF\" width=75%>\n";
   if ($show_faq == 1) {
   ...
   print NEWFILE "<hr size=1 color=\"#0099FF\" width=75%><p>\n";
   ...
   print NEWFILE "<br><hr size=1 color=\"#0099FF\"  width=75%><p>\n";
